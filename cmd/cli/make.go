...
func doMake(arg2, arg3 string) error {
	switch arg2 {
	case "key":
		rnd := scap.RandomString(32)
		color.Yellow("32 character encruption key: %s", rnd)
	case "migration":
		...
		upFile := scap.RootPath + "/migrations/" + fileName + "." + dbType + ".up.sql"
		downFile := scap.RootPath + "/migrations/" + fileName + "." + dbType + ".down.sql"
	...
	case "handler":
		...
		fileName := scap.RootPath + "/handlers/" + strings.ToLower(arg3) + ".go"
